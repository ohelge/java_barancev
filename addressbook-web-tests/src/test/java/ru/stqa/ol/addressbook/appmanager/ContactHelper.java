...
public class ContactHelper extends HelperBase {
  ...
  public void fill(ContactData contactData, boolean creation) { // added boolean creation dlq flaga sozdaniq kontakta, false- dlq modifikacii. Video l3_m08
    ...
    wd.findElement(By.name("photo")).sendKeys(contactData.getPhotoFileName()); // Dla zadaniq l5 vvel getPhotoFileName v ContactData. Sgeneril eto v json file s absolutnim putem
